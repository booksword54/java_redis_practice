...
public class BlogDemo {
     ...
     * 发表博客
     */
    public void publishBlog(long blogId, Map<String, String> blog, String[] tags) {
        ...
        // 文章加标签
        jedis.sadd("article::" + blogId + "::tags", tags);
    }
    ...
    public Map<String, String> findBlogById(long blogId) {
        ...
        // 获取文章标签
        Set<String> tags = jedis.smembers("article::" + blogId + "::tags");
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 20; i++) {
            ...
            demo.publishBlog(blogId, blog, new String[]{"中间件", "Redis", "缓存"});
        }
        // 分页浏览博客
