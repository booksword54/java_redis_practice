...
public class AutoCompleteDemo {
    ...
    public void search(String keyword) {
        ...
        for (char keywordChar : keywordCharArray) {
            ...
            jedis.zincrby("potential_keyword::" + potentialKeyword + "::keywords",
                          ...
                          keyword);
            // 搜索词设置过期时间，冷数据自动淘汰
            jedis.expire("potential_keyword::" + potentialKeyword + "::keywords", 3);
        }
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5 * 1000); // 休眠5s。冷数据过期

        autoCompleteList = demo.getAutoCompleteList("我");
        // 第三次搜索推荐: []
        System.out.println("第三次搜索推荐: " + autoCompleteList);
